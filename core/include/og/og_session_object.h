...
public:
  ...
  OG_COREAPI void get_connected_object_from(list<og_session_object_ptr>* _sesn_obj_list);
  ...
  OG_COREAPI void get_connectable_relation_type_from(list<string>* _rel_type_list);
  ...
  OG_COREAPI boost::optional<og_session_parameter_ptr> get_parameter(string _param_name);
