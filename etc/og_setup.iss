...
Source: "C:\mnt\git2\ObjectGenoise\util\db-updater\x64\Release\db-updater.exe"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: UpdateEnv
