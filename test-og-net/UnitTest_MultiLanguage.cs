...
{
    [TestClass]
    public class UnitTest_MultiLanguage
    {
        private static string JP_DB_PATH = "社会.db";
        ...
        [TestMethod]
        public void multi_lang()
        {
            multilang_1000();
        }
        
        public void multilang_1000()
        {
            new FileInfo(TestInitializer.DBPATH_SRC).CopyTo(JP_DB_PATH, true);

            OGSession cleaned_session_ = new OGSession();

            cleaned_session_.open(JP_DB_PATH);
